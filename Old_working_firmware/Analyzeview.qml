...
Item {
    ...
    property real cartridgeinselected: 0
    ...
    ToolBar {
        ...
        RowLayout {
            ...
            ComboBox {
                    ...
                    currentIndex: 3
                    onCurrentIndexChanged: myanalyzew.cutoffchange(currentIndex)
                }
            ...
            ToolButton {
                ...
                onClicked: {
                    ...
                    myanalyzew.calcshots(ma.starttimes, ma.finishtimes)
            ...
            CheckBox {
                ...
                enabled: true
                onClicked: {
                    myanalyzew.pulsescheck(pulsescheck.checked)
                    ...
                    if (true) {
                        ...
                        for (var k=0; k < numberofchannels; k++){
                            myanalyzew.updateserieanalyze(chartchs.series('ch' + k), 'ch' + k + 'c', checked)
                        }
                        if (checked) {
                            myanalyzew.updateserieanalyze(chartchs.series('pulse'), 'pulsetoplot', checked)
                        }
                    }
                }
            }
    ...
    FileDialog {
        id: fileDialog
        folder: "~/model11/rawdata/"
        nameFilters: ['Data files (*.csv)']
        onAccepted: {
           myanalyzew.openfile(fileUrl)
    ...
    Drawer {
        ...
        RowLayout {
            ...
            GridLayout {
                ...
                RadioButton {
                    ...
                    checked: true
                    onClicked: {
                        myanalyzew.chargecheck(checked)
                        if (dataanalyzed) {
                            if (cartridgeinselected == 0) {
                                ch0box.title = 'CH0'
                ...
                RadioButton {
                    ...
                    autoExclusive: true
                    onClicked: {
                        myanalyzew.chargedosecheck(checked)
                        if (dataanalyzed) {
                            if (cartridgeinselected == 0){
        ...
        ColumnLayout {
            ...
            RadioButton {
                ...
                checked: true
                onClicked: {
                    myanalyzew.centygrayscheck(checked)
    ...
    ChartView {
        ...
        ValueAxis {
            ...
            min: 0
            max: 1
            titleText: "<p>cumulative voltage every 800 &mu;s (V)</p>"
        }
    ...
    Connections {
        ...
        function onSignalcartridgeinselected(cis){
            cartridgeinselected = cis
            console.log('Cartridge in selected from file is: ' + cartridgeinselected)
        }

        function onSignalnumberofchannelsfromfile(nocff){
            numberofchannels = nocff
            console.log('Number of channels from file: ' + numberofchannels)
        }
        ...
        function onSignalfullintegrals(fullintegrals) {
            ...
            for (var k = 0; k < numberofchannels; k++){
                myanalyzew.updateserieanalyze(chartchs.series('ch' + k), 'ch' + k + 'c', pulsescheck.checked)
            }
            myanalyzew.updateserieanalyze(chartchs.series('chargedose'), 'chargedose0', pulsescheck.checked)
            ...
            if (cartridgeinselected == 2) {
                console.log('catridgein now is ' + cartridgeinselected)
        ...
        function onSignalreadytoplot(limits) {
            ...
            myanalyzew.updateserieanalyze(psserie, 'PS0', pulsescheck.checked)
            myanalyzew.updateserieanalyze(tempserie, 'temp', pulsescheck.checked)
            myanalyzew.updateserieanalyze(minus15vserie, '-15V', pulsescheck.checked)
            myanalyzew.updateserieanalyze(v15serie, '15V', pulsescheck.checked)
            myanalyzew.updateserieanalyze(v5serie, '5V', pulsescheck.checked)
