...
=======
#define PSFC 16.218
#define PSFCind 0.1028
>>>>>>> 6dbe61a04a967396b5866bd8958b93e8633fe10a
//#define PSFC 1
//#define PSFCind 0
#define TEST_PIN 10
#define DSDATAPIN 7
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    if (inChar == 'e'){
      Serial.println("This is model10");
      delay (1000);
    }
...
<<<<<<< HEAD
        darkcurrent_limit = -0.5;
        resettimemicros = 70;
=======
        darkcurrent_limit = -0.8;
>>>>>>> 6dbe61a04a967396b5866bd8958b93e8633fe10a
