...
| `sdcstop;` | Requests interruption of an ongoing `sdc...;` or `sdcv...;` auto dark-current routine. The routine checks this command while running and exits early when received. |
